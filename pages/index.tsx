  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://typegen.lxsaihub.com/" />
      </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="testimonials" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-6">Trusted by operators who ship</h2>
            <p className="text-center text-slate-500 max-w-2xl mx-auto mb-10">
              We don't publish invented quotes. When real users agree to be featured, their stories go here.
              Until then, see the <a href="/use-cases" className="text-indigo-600 font-semibold underline">use cases</a> and{' '}
              <a href="/blog" className="text-indigo-600 font-semibold underline">blog</a> for how teams apply {PRODUCT.name}.
            </p>
            <div className="grid md:grid-cols-3 gap-5">
              {[
                ['Live demo', 'Try it yourself', 'Run the studio on this page — no signup required to see output.'],
                ['Transparent pricing', 'No surprises', 'Free tier + Pro. Cancel anytime. See the Pricing section above.'],
                ['Built for solo founders', 'Solo & small teams', "Designed for people who'd rather not live in a spreadsheet."],
              ].map(([nm, role, q]) => (
                <div key={nm} className="bg-white rounded-2xl border border-slate-200 p-6">
                  <p className="text-slate-700 mb-4">{q}</p>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-indigo-600 text-white grid place-items-center font-bold">◆</div>
                    <div>
